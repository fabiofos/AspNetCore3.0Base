...
namespace AspNetCore3._0Base.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAppUser = table.Column<int>(nullable: false),
                    IsActive = table.Column<int>(nullable: false),
                    Pin = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<int>(nullable: false),
                    EnableAlerts = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogEntryWebApi", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subside = table.Column<int>(nullable: false),
